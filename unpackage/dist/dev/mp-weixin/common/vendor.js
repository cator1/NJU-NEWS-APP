...
function initRuntimeSocketService() {
  const hosts = "26.26.26.1,192.168.56.1,192.168.9.20,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_rEtIaL";
...
const pages = [
  ...
  {
    path: "pages/tabbar/lecture/lecture",
    style: {
      navigationBarShadow: {
        colorType: "grey"
      }
  ...
  {
    path: "pages/tabbar/lecture/lectureDetail",
    style: {
      navigationBarTitleText: "讲座详情"
    }
  },
  {
    path: "pages/tabbar/index/indexDetail",
    style: {
  ...
  list: [
    {
      ...
      selectedIconPath: "/static/activity_cli.png"
    },
    {
      pagePath: "pages/tabbar/lecture/lecture",
      text: "讲座",
      iconPath: "/static/lecture.png",
      selectedIconPath: "/static/lecture_cli.png"
    },
    {
      pagePath: "pages/tabbar/other/other",
      text: "个人",
      iconPath: "/static/setting.png",
      selectedIconPath: "/static/setting_cli.png"
    }
  ]
};
const globalStyle = {
  navigationBarTextStyle: "white",
  navigationBarTitleText: "南 哪 小 报",
  navigationBarBackgroundColor: "#816eee",
...
const S = true, b = "mp-weixin", T = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = b, P = I('{"address":["127.0.0.1","26.26.26.1","192.168.56.1","192.168.9.20"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/NJU/code/NJUnews/HBuilderX/plugins/unicloud/**/*.js"]}'), C = I('[{"provider":"aliyun","spaceName":"njunews-v-ctrl","spaceId":"mp-e468c996-fdd3-4c1f-84df-50dfa3673ab5","clientSecret":"KvvvoI1uUIz5KoeUkPDaTQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__B296805";
} catch (e2) {
